...
import com.sjjybsgj.dao.index.model.MenuModel;
...
public class IndexController extends BaseController {
	...
	public List<MenuModel> menu(@PathVariable String roleId) {
		if ("admin".equals(this.getSessionUser().getUserType())) {
			...
			List<MenuModel> rootList = delegateMapper.selectList("com.sjjybsgj.dao.index.mapper.IndexCustomMapper.getMenu", paramMap);
	...
	private List<MenuModel> getMenu(String pid, String roleId) {
		...
		List<MenuModel> list = new ArrayList<>();
		List<MenuModel> menuList = delegateMapper.selectList("com.sjjybsgj.dao.index.mapper.IndexCustomMapper.getMenu", paramMap);
