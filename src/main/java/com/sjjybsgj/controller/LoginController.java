...
import com.sjjybsgj.dao.login.model.LoginModel;
...
public class LoginController extends BaseController {
	...
	public LoginModel signin(String username, String password, boolean remember) {
        ...
        LoginUser loginUser = delegateMapper.selectOne("com.sjjybsgj.dao.login.mapper.LoginCustomMapper.getLoginUser", paramMap);
        ...
        List<Map<String, Object>> userRoles = delegateMapper.selectList("com.sjjybsgj.dao.login.mapper.LoginCustomMapper.getUserRoles", loginUser.getUserId());
